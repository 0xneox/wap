...
function tubeaceplay_enqueue()  { 
  ...
  $fonts = [
    ...
    get_theme_mod('pagination_prev_font_family'),
    get_theme_mod('pagination_current_font_family'),
    get_theme_mod('pagination_num_font_family'),
    get_theme_mod('pagination_num_hover_font_family'),
    get_theme_mod('pagination_next_font_family'),
    ...
    get_theme_mod('post_page_related_font_family'),
  ...
  if( sizeof($fonts)>0 ){
    ...
    wp_enqueue_style( 'tubeaceplay-fonts', 'https://fonts.googleapis.com/css?family='.$fonts, false );
  }
