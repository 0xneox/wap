<?php 
/**
 * Displays video attachment page.
 *
 * @package       Tube Ace
 * @subpackage    Play
 * @since         Play 1.0
    ...
    <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
      ...
      <?php while ( have_posts() ) : the_post(); ?>
        ...
        <div id="attachment">
          ...
          <?php echo do_shortcode('[video src="'.wp_get_attachment_url().'"]') ?>
          ...
          <footer>
            <?php 
            //date & time
            echo get_theme_mod('attachment_page_date_label', $tubeaceplay_defaults['attachment_page_date_label']); ?>
